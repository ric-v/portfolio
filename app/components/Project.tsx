...
const Project = ({ owner, name }: Props) => {
  ...
  return (
    <>
      <div className={`rounded-2xl text-center p-5 backdrop-blur-sm backdrop-brightness-95 hover:scale-110 hover:backdrop-brightness-90 cursor-pointer ${transition}`} onClick={() => setExpand(true)}>
