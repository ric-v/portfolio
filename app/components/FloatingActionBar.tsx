  ...
  return (
    <>
      ...
      >
        ...
        {isOpen && (
          <div
            className={`absolute bottom-16 right-10 w-56 text-xl bg-slate-100 dark:bg-slate-700 rounded-lg shadow-lg p-5`}
          >
            <div className="flex flex-col justify-between">
              <Link
                to="/"
                className="text-gray-400 dark:text-gray-400 hover:text-gray-800 hover:dark:text-gray-50 p-1"
              >
                Home
              </Link>
              ...
              <p
                ...
                onClick={() => {
                  ...
                  localStorage.setItem(
                    "enableStarLight",
                    (!enableStarLight).toString()
                  );
                }}
              >
                {enableStarLight ? "Disable Starlight" : "Enable Starlight"}
              </p>
            </div>
          </div>
        )}
