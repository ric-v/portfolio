      ...
      <Parallax ref={parallax} pages={7} className="scrollbar-none">
        ...
        >
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 mt-5">
            <div className="bg-black rounded-xl p-2" on>01</div>
