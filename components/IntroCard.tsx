  ...
  return (
    <>
      ...
      <div className="pt-20 sm:pt-32 md:pt-44 grid grid-cols-3 md:grid-cols-4 gap-1 transition-all duration-1000">
        ...
        <div className="col-span-3 md:col-span-2 bg-amber-400 dark:bg-sky-500 bg-opacity-10  scale-90 hover:scale-100 
          ...
          <Image
            ...
            unoptimized={true}
            className={
              `rounded-full w-40 h-40 z-70 shadow-xl absolute top-1.5 left-1/2 transform -translate-x-1/2 -translate-y-1/2
              saturate-50 border-slate-400 border-spacing-16 border-8 opacity-90 contrast-125 brightness-100
              hover:scale-150 hover:-translate-y-5 hover:shadow-3xl transition-all duration-2000`
            }
          />
          <div className="h-full w-full mt-5 flex flex-col justify-center items-center">
            ...
            <div
              className="mt-2 font-sans text-3xl md:text-4xl font-medium text-center 
                      text-slate-800 dark:text-sky-300 drop-shadow-xl
                      animate-pulse hover:animate-none hover:scale-110
                      transition-all duration-1000"
            >
              <div className='mt-5 font-display text-sm md:text-md font-medium text-center text-slate-500 dark:text-sky-200 drop-shadow-xl'>
                Hey, this is
              </div>
              {user.name}
            </div>
